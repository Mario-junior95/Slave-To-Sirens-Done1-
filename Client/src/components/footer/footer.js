    ...
    <div className="footer">
      <div className="footer-postion footer-reviews">
        <div className="social-media social-media-facebook">
          <a target="_blank" href="https://www.facebook.com/Slavetosirens/" rel="noreferrer">
        ...
        <div className=" social-media social-media-instagram">
          <a
            target="_blank"
            href="https://www.instagram.com/slavetosirensband/" rel="noreferrer"
          >
            <img
        ...
        <div className=" social-media social-media-whatsapp">
          <a
            target="_blank"
            href="https://api.whatsapp.com/send?phone=+961 81 916 009" rel="noreferrer"
          >
        ...
        <div className=" social-media social-media-mail">
          <a
            target="_blank"
            href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=slavetosirens@gmail.com" rel="noreferrer"
          >
      ...
      <div className="copyright">
        <p>
          ...
          <a
            target="_blank"
            href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=codestalers@gmail.com" rel="noreferrer"
          >
            Code Stellars.
          </a>
          All Rights Reserved
